	...
	namespace Library
	{
		namespace API
		{
			...
			*/
			...
			\return openCONFIGURATOR::Library::ErrorHandling::Result
			*/
			DLLEXPORT openCONFIGURATOR::Library::ErrorHandling::Result GetViewSetting(const openCONFIGURATOR::GUI::ProjectFile::ViewType::ViewType viewType, const std::string name, std::string& value);
