	...
	namespace Library
	{
		namespace API
		{
			...
			*/
			...
			\deprecated Since 1.4.0
			*/
			openCONFIGURATOR::Library::ErrorHandling::Result SetIndexAttribute(const UINT32 nodeId, const UINT32 index, AttributeType attributeType, const std::string attributeValue);
