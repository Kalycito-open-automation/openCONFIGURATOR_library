...
#define LOG_TRACE() ELOG(cerr)
#define LOG_DEBUG() ELOG(cerr)
#define LOG_INFO() ELOG(cerr)
#define LOG_WARN() ELOG(cerr)
#define LOG_ERROR() ELOG(cerr)
#define LOG_FATAL() ELOG(cerr)
